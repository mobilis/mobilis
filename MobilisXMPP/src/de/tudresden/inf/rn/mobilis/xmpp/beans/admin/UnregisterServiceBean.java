...
public class UnregisterServiceBean extends XMPPBean {
	...
	public UnregisterServiceBean() {
		super();
		
		this.type = XMPPBean.TYPE_RESULT;
	}
	
	public UnregisterServiceBean(String serviceNamespace, int serviceVersion) {
		super();
	...
	public UnregisterServiceBean(String errorType, String errorCondition, String errorText) {
		super(errorType, errorCondition, errorText);	
	}
	

	@Override
	public UnregisterServiceBean clone() {
		UnregisterServiceBean clone = new UnregisterServiceBean(this.ServiceNamespace, this.ServiceVersion);
		
		clone = (UnregisterServiceBean) cloneBasicAttributes(clone);
