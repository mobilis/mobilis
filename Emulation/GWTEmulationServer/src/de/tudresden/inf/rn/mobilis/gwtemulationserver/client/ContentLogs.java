...
public class ContentLogs extends ScrollPanel {
	...
	private FocusPanel getRow(Long id, Date start, Date end, String script, Boolean mouseOver) {
		
		/*final HorizontalPanel hp = new HorizontalPanel();
		Label l1 = new Label(id.toString());
		Label l2 = new Label(start.toString());
		Label l3 = new Label(end.toString());
		Label l4 = new Label(script);
		l1.setWidth("100px");
		l2.setWidth("250px");
		l3.setWidth("250px");
