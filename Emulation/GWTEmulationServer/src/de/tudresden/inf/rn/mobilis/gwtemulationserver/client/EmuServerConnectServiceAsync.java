...
public interface EmuServerConnectServiceAsync {
	...
	public void startScript(String script, Map<String, String> instanceSelection, Map<String, InstanceGroupExecutorInfo> instanceGroupSelection, AsyncCallback<Boolean> callback);
	public void getSessionList(AsyncCallback<SessionList> callback);
