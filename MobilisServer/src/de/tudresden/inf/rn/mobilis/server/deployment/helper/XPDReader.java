 ...
 */
public abstract class XPDReader {
	...
	private static final String XPD_SERVICE_NAMESPACE = "ident";

	/** The xml tag for the service version element. */
	private static final String XPD_SERVICE_VERSION = "version";

	/** The xml tag for the service name element. */
	private static final String XPD_SERVICE_NAME = "name";
