...
public class AddListEntryResponse extends XMPPBean {

	private static final long serialVersionUID = -765718757550567137L;
	private ListEntry listEntry = null;

	public AddListEntryResponse(ListEntry listEntry) {
		super();
	...
	public static final String CHILD_ELEMENT = "AddListEntryResponse";
	...
	public XMPPBean clone() {
		AddListEntryResponse clone = new AddListEntryResponse( listEntry );
