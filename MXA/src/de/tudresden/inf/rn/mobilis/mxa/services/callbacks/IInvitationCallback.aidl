...
oneway interface IInvitationCallback {

    /**
     * Called on a received MultiUserChat invitation.
     */
    void onInvitationReceived(String room, String inviter, String reason, String password, in XMPPMessage message);
}